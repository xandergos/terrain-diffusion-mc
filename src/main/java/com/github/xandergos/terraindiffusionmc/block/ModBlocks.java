...
public final class ModBlocks {
    ...
    /** Thin-to-full grass layers ; overgrown river margins. */
    public static final LayeredBlock GRASS_LAYER              = registerLayered("grass",              Blocks.GRASS_BLOCK, copyOf(Blocks.GRASS_BLOCK));
    ...
    /**
     * Triggers static initialisation of this class (registering all blocks) and inserts
    ...
    public static void register() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.NATURAL).register(entries -> {
            entries.addBefore(Blocks.GRASS_BLOCK,  GRASS_LAYER);
