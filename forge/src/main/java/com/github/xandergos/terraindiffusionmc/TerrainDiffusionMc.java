...
public class TerrainDiffusionMc {
    ...
    public TerrainDiffusionMc() {
        ...
        LOG.warn("terrain-diffusion-mc Forge entrypoint is present. Common code has been moved to Mojang/Parchment mappings; Forge registration still needs loader-specific wiring.");
    }
}
